...
**Response:** Updated agent summary (200), or `{ "error": "..." }` (400 / 404).
...
- Skills are loaded from your skills directory only — no remote fetching
...
- [Addons](./addons/README.md) — a separate plugin system, not to be confused with skills
- [Creating Skills](./creating-skills.md) — a quick-start guide to writing your own
