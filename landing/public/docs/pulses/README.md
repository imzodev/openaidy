...
- [Technical Specification](./pulses-technical-specification.md) — architecture, data model, API design
- [Phase 1: Backend](./pulses-phase-1-backend.md) — server routes, scheduler integration, isolated sessions
- [Phase 2: Frontend](./pulses-phase-2-frontend.md) — UI, API client, routing
