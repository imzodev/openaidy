...
No. Skills are pure text injected into the system prompt. They cannot execute code or make API calls. For that, use [builtin tools](../plugin-sdk.md) or MCP servers.
