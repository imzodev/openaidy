import { pgTable, text, timestamp, integer, jsonb, pgEnum, uuid, index } from 'drizzle-orm/pg-core';
 ...
 */
export const jobTargetTypeEnum = pgEnum('job_target_type', ['session', 'isolated']);
